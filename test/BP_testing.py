...
-------------------------------------------------------------
Descripción:
 . Algoritmo para testear que los datos sean los correctos. 
...
import sarPrm_testing as sp # Library created to define sistem parameters
...
def plot_image(data2):
    ...
    fig.savefig(direction,orientation='landscape')
...
def main(dset_name): # Raw data file name, index of image to be reconstructed('0' default), directory where log imaging is saved 
    
    plt.close('all') # Cerrar todas las figuras previas

    # Se declaran y cargan variables
    dirc = "/media/soporte/e2a2d167-bcfd-400a-91c8-f1236df2f7e4/soporte/Landslide_Project/Desarrollo/Software/Procesamiento/Data_set/test/" # directory of the raw data
